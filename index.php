...
<body>
    <section class="congratulations">
        <h1>Поздравляем!</h1>
        <p>Твой AWS Elastic Beanstalk <em>PHP</em> application is now running on your own dedicated environment in the AWS&nbsp;Cloud</p>
        <p>Вы запустили  PHP приложение <?= phpversion() ?></p>
        <p>Запушено с исользованием Elastic Beanstalk PHP Платформою</p>
    </section>
